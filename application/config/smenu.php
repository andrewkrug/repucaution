...
$config['smenu']['dashboard'] = array(
    ...
    'reviews' => array(
        '#title' => 'Reviews',
        '#weight' => 4,
        '#icon_class' => 'customer_icon-reviews',
        '#class' => array('settings_link'),
        '#open' => true,
    ),
    ...
    'traffic' => array(
        ...
        '#weight' => 10,
        '#icon_class' => 'customer_icon-traffic',
        '#class' => array('settings_link'),
    ),
    'videotrainings' => array(
        '#title' => 'Video Trainings',
        '#weight' => 12,
        '#icon_class' => 'customer_icon-videos',
        '#class' => array('settings_link'),
    )
