...
class Stomp
{
    ...
    protected function _writeFrame (StompFrame $stompFrame)
    {
        ...
        if (isset($stompFrame->headers['suppress_content_length'])
            && $stompFrame->headers['suppress_content_length'] === 'true'
        ) {
            unset($stompFrame->headers['suppress_content_length']);
            $data = $stompFrame->__toString();
            $r = fwrite($this->_socket, $data);
        } else {
            $data = $stompFrame->__toString();
