(function($) {
    ...
    var $tbody = {
        hidden : $('.tablebox.hidden-phone table tbody'),
        visible : $('.tablebox.visible-phone table tbody')
    };
            ...
            function (response, xhr, status) {
                if (response) {
                    if (response.success) {
                        ...
                        $tbody.hidden.html(hidden_phone_html);
                        $tbody.visible.html(visible_phone_html);
