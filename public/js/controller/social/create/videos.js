(function ($) {
  ...
  $(".inputFile").fileupload({
    ...
    fail: function (e, data) {
      $('.file').show();
      $load_div.parent().find('label').append('<span class="message-error">File type not supported. Please try again with a different video</span>');
    },
    add: function (e, data) {
  ...
  $(document).on('submit', '#post-video-form', function () {
    var $self = $(this);
