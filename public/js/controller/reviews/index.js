...
jQuery(function ($) {
    ...
    $('#apply_button').click(get_directory_details);
    ...
    function loadReviews() {
        ...
        inProcess = true;
        $ajax_container = $('.messageList');
        $ajax_container.append($loading);

        var data = 'directory='+g_settings.directory.id+'&offset='+$('.reviews-inner').length;
    ...
    $(window).scroll(function() {
        var lastReview = $('.reviews-inner').last();
